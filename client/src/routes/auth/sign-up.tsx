    ...
    <div className="min-h-screen flex items-center justify-center bg-bg text-text px-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <Link to="/" className="font-display text-2xl text-h1 hover:text-h2 transition-colors">
            Applera
          </Link>
          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formFieldInput: "bg-bg border border-border text-body rounded-lg focus:border-primary/40",
