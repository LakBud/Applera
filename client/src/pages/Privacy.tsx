    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <p>
              Your CVs and application data are stored securely in our database. PDF files are stored on Cloudinary and are only
              accessible through authenticated endpoints — your files are never publicly accessible by URL. We use Redis for
              temporary caching of AI-generated content.
            </p>
          ),
        },
        {
          ...
          content: (
            <>
              ...
              />
              <p>
                We do not sell your data to any third party. Data shared with the above services is limited to what is necessary
        ...
        },
        {
          ...
          content: (
            <p>
              Your CV and job listing content is sent to Groq's API to generate application output. This data is processed in
              accordance with Groq's privacy policy. We do not use your content to train AI models.
            </p>
          ),
        },
        {
          ...
          content: (
            <p>
              Your data is retained as long as your account is active. You can delete your CVs and applications at any time from
              the app. To fully delete your account and all associated data, do it within account settings.
            </p>
          ),
        },
        {
        ...
        {
          title: "Cookies",
          content: <p>We use a session cookie to authenticate your account. We do not use tracking or advertising cookies.</p>,
        },
        {
