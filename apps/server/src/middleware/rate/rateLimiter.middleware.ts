...
export const interviewPrepLimiter = limiter({
  windowMinutes: 60,
  max: 10,
  message: 'Too many interview prep requests. Please wait before trying again.',
  keyPrefix: 'interviewPrep',
});
...
export const deleteCVLimiter = limiter({
  windowMinutes: 15,
  max: 30,
