...
- **Mistral (primary) + Groq (fallback)**, via [vern-llm](https://vernllm.vercel.app), for
  AI-powered CV parsing, application generation, and interview prep
...
| Auth             | Clerk                                             |
| AI               | Mistral (primary), Groq (fallback), via vern-llm  |
| Storage          | Cloudinary                                        |
